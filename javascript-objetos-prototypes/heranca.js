...
//Camiseta herda as chaves e os métodos de Produto além de poder adicionar novos
function Camiseta (nome, preco, cor) {
    Produto.call(this, nome, preco) //this neste caso vai ser objeto criado a partir desta função 
    this.cor = cor;
}
//Setando os prototypes de Produto nos da Camiseta
Camiseta.prototype = Object.create(Produto.prototype);
 //garantindo que o valor de constructor do objeto vai ser Camiseta pois é alterado para Produto
Camiseta.prototype.constructor = Camiseta;

//Definindo um método de aumento próprio para Camiseta 
    ...
    Object.defineProperty(this, 'estoque', {
        ...
        set: function(valor) {
            if(typeof valor !== 'number') {
                throw new TypeError('Valor is not a number')
...
const caneca = new Caneca('Stitch', 20, 'Vidro', 5); 
caneca.estoque = 10; //setando o valor de estoque(set)
caneca.desconto(10);
caneca.aumento(20);
console.log(caneca);
console.log(caneca.estoque);// pegando o esto que de caneca(get)
