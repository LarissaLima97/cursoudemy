...
var ValidaCpf = /*#__PURE__*/function () {
  ...
  return _createClass(ValidaCpf, [{
    ...
    value: function validaCpf() {
      ...
      var primeiroDigito = this.criaDigito(cpfSemDigitos);
      var segundoDigito = this.criaDigito(cpfSemDigitos + primeiroDigito);
      var cpfValidado = cpfSemDigitos + primeiroDigito + segundoDigito;
      return cpfValidado === this.cpfLimpo ? true : false;
    }
  }, {
    key: "isSequencia",
    value: function isSequencia() {
      var sequencia = this.cpfLimpo[0].repeat(this.cpfLimpo.length);
      return sequencia === this.cpfLimpo;
    }
  }], [{
    key: "criaDigito",
    value: function criaDigito(cpfSemDigitos) {
      var total = 0;
      var regressivo = cpfSemDigitos.length + 1;
...
`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;IACI,yCAAyC;IACzC,0CAA0C;AAC9C;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,SAAS;IACT,UAAU;IACV,sCAAsC;IACtC,oCAAoC;IACpC,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,iBAAiB;IACjB,kBAAkB;IAClB,4BAA4B;IAC5B,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,mBAAmB;IACnB,YAAY;AAChB;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,YAAY;IACZ,qCAAqC;IACrC,YAAY;IACZ,gBAAgB;IAChB,eAAe;IACf,gBAAgB;IAChB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,sCAAsC;AAC1C;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,2BAA2B;IAC3B,kBAAkB;IAClB,iBAAiB;IACjB,mBAAmB;IACnB,mBAAmB;AACvB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap');\n\n:root {\n    --primary-color: rgba(90, 60, 116, 0.808);\n    --second-color: rgba(194, 151, 231, 0.808);\n}\n\n* {\n    box-sizing: border-box;\n    outline: 0;\n}\n\nbody {\n    margin: 0; \n    padding: 0;\n    background-color: var(--primary-color);\n    font-family: 'Open Sans', sans-serif;\n    font-size: 1.3em;\n    line-height: 1.5em;\n}\n\n.container {\n    max-width: 640px;\n    margin-top: 50px;\n    margin-left: auto;\n    margin-right: auto;\n    background-color: whitesmoke;\n    padding: 20px;\n    border-radius: 10px;\n}\n\nform input, form label, form button {\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\nform input { \n    font-size: 24px;\n    height: 50px;\n    border-radius: 10px;\n    border: none;\n}\n\nform input:focus {\n    outline: 1px solid var(--second-color) ;\n}\n\nform button {\n    border: none;\n    background-color: var(--second-color);\n    height: 50px;\n    margin-top: 20px;\n    font-size: 20px;\n    font-weight: 700;\n    color: whitesmoke;\n    cursor: pointer;\n}\n\nform button:hover {\n    background-color: var(--primary-color);\n}\n\n.container h1 {\n    text-align: center;\n    margin-bottom: 40px;\n}\n\n.cpf-gerado {\n    font-size: 2em;\n    color: var(--primary-color);\n    text-align: center;\n    font-weight: bold;\n    margin-bottom: 40px;\n    letter-spacing: 3px;\n}\n"],"sourceRoot":""}]);
// Exports
