...
var qtdeCaracteres = document.querySelector('.qtd-caracteres');
var chkMaiscula = document.querySelector('.chk-maisculas');
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdeCaracteres.value, chkMaiscula.checked, chkMinuscula.checked, chkNumeros.checked, chkSimbolos.checked);
...
function geraSenha(qtd, maiscula, minuscula, numeros, simbolos) {
  var senhaArray = [];
  qtd = Number(qtd);
  for (var i = 0; i <= qtd; i++) {
...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    --primary-color: rgba(90, 60, 116, 0.808);
    --second-color: rgba(194, 151, 231, 0.808);
}
...
.senha-gerada {
    ...
    margin: 40px 0;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;IACI,yCAAyC;IACzC,0CAA0C;AAC9C;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,SAAS;IACT,UAAU;IACV,sCAAsC;IACtC,oCAAoC;IACpC,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,iBAAiB;IACjB,kBAAkB;IAClB,4BAA4B;IAC5B,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,mBAAmB;AACvB;;CAEC;IACG,eAAe;IACf,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,oCAAoC;AACxC;;AAEA;IACI,WAAW;IACX,YAAY;IACZ;AACJ;;CAEC;IACG,uCAAuC;AAC3C;;CAEC;IACG,cAAc;IACd,WAAW;IACX,mBAAmB;IACnB,YAAY;IACZ,qCAAqC;IACrC,YAAY;IACZ,gBAAgB;IAChB,eAAe;IACf,gBAAgB;IAChB,iBAAiB;IACjB,eAAe;AACnB;;CAEC;IACG,sCAAsC;AAC1C;;AAEA;IACI,cAAc;IACd,2BAA2B;IAC3B,cAAc;AAClB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap');\n\n:root {\n    --primary-color: rgba(90, 60, 116, 0.808);\n    --second-color: rgba(194, 151, 231, 0.808);\n}\n\n* {\n    box-sizing: border-box;\n    outline: 0;\n}\n\nbody {\n    margin: 0; \n    padding: 0;\n    background-color: var(--primary-color);\n    font-family: 'Open Sans', sans-serif;\n    font-size: 1.3em;\n    line-height: 1.5em;\n}\n\n.container {\n    max-width: 640px;\n    margin-top: 50px;\n    margin-left: auto;\n    margin-right: auto;\n    background-color: whitesmoke;\n    padding: 20px;\n    border-radius: 10px;\n}\n\n.wrapper {\n    display: block;\n    margin-bottom: 10px;\n}\n\n input { \n    font-size: 15px;\n    padding: 5px;\n    border-radius: 10px;\n    border: none;\n    border: 1px solid rgb(118, 118, 118);\n}\n\ninput[type=checkbox] {\n    width: 20px;\n    height: 20px;\n    border-color: var(--second-color)\n}\n\n input:focus {\n    outline: 1px solid var(--second-color) ;\n}\n\n button {\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n    border: none;\n    background-color: var(--second-color);\n    height: 50px;\n    margin-top: 20px;\n    font-size: 20px;\n    font-weight: 700;\n    color: whitesmoke;\n    cursor: pointer;\n}\n\n button:hover {\n    background-color: var(--primary-color);\n}\n\n.senha-gerada {\n    font-size: 2em;\n    color: var(--primary-color);\n    margin: 40px 0;\n}"],"sourceRoot":""}]);
// Exports
